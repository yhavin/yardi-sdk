...
if __name__ == "__main__":
    ...
    rm_wsdl = os.getenv("RM_WSDL_URL")
    lr_wsdl = os.getenv("LR_WSDL_URL")
    ils_wsdl = os.getenv("ILS_WSDL_URL")
    ...
    generator = EndpointGenerator(rm_wsdl, "Revenue Management").generate(output_file="src/yardi_sdk/endpoints/revenue_management.py")
    generator = EndpointGenerator(lr_wsdl, "Lease Renewals").generate(output_file="src/yardi_sdk/endpoints/lease_renewals.py")
    generator = EndpointGenerator(ils_wsdl, "ILS/Guest Card").generate(output_file="src/yardi_sdk/endpoints/ils_guest_card.py")